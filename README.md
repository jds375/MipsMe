...
###Writing Your Own MIPS Code###
Since learning Computer Science is hands-on, I have provided a simple and easy way for you to write your own MIPS code. To do this simply clone this repo. Then in your terminal execute the MipsMe file with the argument being the file with the MIPS code you want to execute. For example, on mac you would do: './MipsMe test.txt'. If you would like to regenerate this script file, simply compile it usign standard GCC.
